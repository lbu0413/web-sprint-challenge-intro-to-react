...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
  React is a javascript library that helps developers make more interactive and complex UI.

1. Describe component state.
  state is an object thats managed inside a component. When state changes component responds and re renders.

1. Describe props.
  props is an object just like state but it gets passed to the component like function parameters.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
  useEffect runs after every render but we can set specific effect under UseEffect.
